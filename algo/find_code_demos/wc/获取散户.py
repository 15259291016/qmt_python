...
class WC:
    def __init__(self, token=''):
        self.data_dict = {
            ...
            "2":["双成药业、华灿光电、川环科技、欣天科技、浙江自然", self.f2],      #需要情绪周期配合
...
wc = WC()
# 中国核电、国机精工、鲁抗医药、电光科技、淮柴重工、小方制药、川发龙蟒、中际旭创
# 实益达、浪潮信息、川润股份、粤传媒、电光科技、威奥股份、小方制药、好想你、中兴通讯、长青集团
# 哈森股份、东峰集团、四川长虹、广百股份、欧菲光、东风股份、通富微电、南京公用
# 双成药业、华灿光电、川环科技、欣天科技、浙江自然
wc.data_dict["0"][1](wc.data_dict["0"][0], "嵘泰股份")  #电光科技、好想你       
# wc.data_dict["1"][1](wc.data_dict["1"][0])
